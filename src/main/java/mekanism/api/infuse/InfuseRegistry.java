...
public class InfuseRegistry {
     ...
     * of infuse, and will deliver this amount to the Metallurgic Infuser's buffer of infuse. The item's stack size will
     * be decremented when it is placed in the Metallurgic Infuser's infuse slot, and the machine can accept the type
     * and amount of infuse stored in the object.
     * 
