...
public class TileFissionReactorSteam extends TileSteamProducer {
    ...
    public static String[] cellTypes = { "LEU235Cell", "HEU235Cell", "LEP239Cell", "HEP239Cell", "MOX239Cell",
            ...
            "LEN236Cell", "HEN236Cell", "LEA242Cell", "HEA242Cell", "LEC243Cell", "HEC243Cell", "LEC245Cell",
            "HEC245Cell", "LEC247Cell", "HEC247Cell",

            "LEN236CellOxide", "HEN236CellOxide", "LEA242CellOxide", "HEA242CellOxide", "LEC243CellOxide",
            "HEC243CellOxide", "LEC245CellOxide", "HEC245CellOxide", "LEC247CellOxide", "HEC247CellOxide",
            "TBUCellOxide" };
    ...
    public static String[] fuelTypes = { "LEU", "HEU", "LEP", "HEP", "MOX", "TBU", "LEU", "HEU", "LEP", "HEP", "MOX",
            ...
            "LEN-Ox", "HEN-Ox", "LEA-Ox", "HEA-Ox", "LEC-Ox", "HEC-Ox", "LEC-Ox", "HEC-Ox", "LEC-Ox", "HEC-Ox",
            "TBU-Ox" };
        ...
        if (off == 0 && flag) {
            ...
            if ((int) SReal < 200) {
                if (tank.getFluidAmount() != 0)
                    if (tank.getFluid().getFluid() != NuclearCraft.steam) tank.drain(100000, true);
                if (steam >= 200) {
                ...
                if (tank.getFluidAmount() != 0)
                    if (tank.getFluid().getFluid() != NuclearCraft.denseSteam) tank.drain(100000, true);
                if (steam >= 40000) {
                ...
                if (tank.getFluidAmount() != 0)
                    if (tank.getFluid().getFluid() != NuclearCraft.superdenseSteam) tank.drain(100000, true);
                for (int i = 0; i < 100; i++) {
                    if (steam >= 1000000) {
        ...
        if (slots[1] != null) {
            ...
            if (OreDictionary.getOreIDs(slots[1]).length == 0 || OreDictionary.getOreIDs(slots[1]) == null)
                for (int id : OreDictionary.getOreIDs(slots[1])) {
                    if (OreDictionary.getOres("d" + cellTypes[type - 1]).get(0).getItem()
                            == OreDictionary.getOres(OreDictionary.getOreName(id)).get(0).getItem()
                            && OreDictionary.getOres("d" + cellTypes[type - 1]).get(0).getItemDamage()
                                    == OreDictionary.getOres(OreDictionary.getOreName(id)).get(0).getItemDamage()
    ...
    private void product() {
        if (slots[1] == null && fueltime <= 0 && fueltype != 0) {
            for (int i = 0; i < cellTypes.length; i++) {
                if (fueltype == i + 1) {
                    slots[1] = new ItemStack(
                            OreDictionary.getOres("d" + cellTypes[i]).get(0).getItem(),
                            1,
                            OreDictionary.getOres("d" + cellTypes[i]).get(0).getItemDamage());
                    fueltype = 0;
                }
            }
            fueltime = 0;
            ...
            for (int i = 0; i < cellTypes.length; i++) {
                for (int id : OreDictionary.getOreIDs(slots[1])) {
                    if (OreDictionary.getOres("d" + cellTypes[i]).get(0).getItem()
                            == OreDictionary.getOres(OreDictionary.getOreName(id)).get(0).getItem()
                            && OreDictionary.getOres("d" + cellTypes[i]).get(0).getItemDamage()
                                    == OreDictionary.getOres(OreDictionary.getOreName(id)).get(0).getItemDamage()
                            && slots[1].stackSize < 64) {
