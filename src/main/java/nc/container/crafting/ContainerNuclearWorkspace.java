...
public class ContainerNuclearWorkspace extends Container {
    ...
    public void onCraftMatrixChanged(IInventory iinventory) {
        craftResult.setInventorySlotContents(
                0,
                NuclearWorkspaceCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
    }
    ...
    /*
     * public boolean func_94530_a(ItemStack stack, Slot slot) { return slot.inventory != this.craftResult &&
     * super.func_94530_a(stack, slot); }
     */
}
