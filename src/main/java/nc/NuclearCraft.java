...
public class NuclearCraft {
    ...
    public void preInit(FMLPreInitializationEvent event) {
         ...
         * "after:minecraft:shaped"); RecipeSorter.register("nuclearcraft:workspaceshapeless",
         * NuclearWorkspaceShapelessOreRecipe.class, Category.SHAPELESS, "after:minecraft:shapeless");
         */
        ...
        NCBlocks.blockFusionPlasma = new BlockPlasma(
                ...
                NuclearCraft.plasmaburn).setCreativeTab(tabNC).setBlockName("fusionPlasmaBlock");
        ...
        NCBlocks.blockDenseSteam = new BlockDenseSteam(
                ...
                NuclearCraft.steamburn).setCreativeTab(tabNC).setBlockName("denseSteamBlock");
        ...
        NCBlocks.blockSuperdenseSteam = new BlockSuperdenseSteam(
                superdenseSteam,
                steamMaterial.setReplaceable(),
                NuclearCraft.steamburn).setCreativeTab(tabNC).setBlockName("superdenseSteamBlock");
        GameRegistry.registerBlock(NCBlocks.blockSuperdenseSteam, "superdenseSteamBlock");

        // Ore Registry
        GameRegistry.registerBlock(
                NCBlocks.blockOre = new BlockOre("blockOre", Material.rock),
                ItemBlockOre.class,
                "blockOre");
        ...
        NCBlocks.lithiumIonBatteryBlock = new BlockLithiumIonBattery().setBlockName("lithiumIonBatteryBlock")
                .setCreativeTab(tabNC).setStepSound(Block.soundTypeMetal).setResistance(5.0F).setHardness(5.0F);
        GameRegistry.registerBlock(
                NCBlocks.lithiumIonBatteryBlock,
                ItemBlockLithiumIonBattery.class,
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ...
                        true,
                        new Object[] { "XPX", "PFP", "XPX", 'P', "plateBasic", 'X', "dustObsidian", 'F',
                                Blocks.furnace }));
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ...
                        true,
                        new Object[] { "PPP", "PCP", "PPP", 'P', "plateIron", 'C',
                                new ItemStack(NCItems.parts, 1, 2) }));
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ...
                        true,
                        new Object[] { "PRP", "RCR", "PRP", 'P', "plateIron", 'R', new ItemStack(NCItems.parts, 1, 12),
                                'C', NCBlocks.furnaceIdle }));
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        NCBlocks.electricCrusherIdle,
                        true,
                        new Object[] { "PRP", "RCR", "PRP", 'P', "plateIron", 'R', new ItemStack(NCItems.parts, 1, 12),
                                'C', NCBlocks.crusherIdle }));
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(NCItems.material, 9, 50),
                new Object[] { new ItemStack(NCBlocks.blockBlock, 1, 10) });
        GameRegistry.addShapelessRecipe(
                new ItemStack(NCItems.material, 9, 76),
                new Object[] { new ItemStack(NCBlocks.graphiteBlock, 1) });

        GameRegistry.addShapelessRecipe(
                new ItemStack(NCBlocks.tubing1, 1),
                new Object[] { new ItemStack(NCBlocks.tubing2) });
        GameRegistry.addShapelessRecipe(
                new ItemStack(NCBlocks.tubing2, 1),
        ...
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        ...
                        new Object[] { Items.cooked_beef, Items.cooked_porkchop, Items.cooked_chicken,
                                Blocks.brown_mushroom, Blocks.brown_mushroom, Items.bread, Items.bread }));
        ...
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.material, 3, 72),
        ...
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.fishAndRicecake, 1),
                        new Object[] { Items.cooked_fished, NCItems.ricecake }));

        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.recordPractice, 1),
                        new Object[] { "record", "ingotBoron" }));
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.recordArea51, 1),
        ...
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        ...
                        new Object[] { new ItemStack(NCItems.parts, 1, 4), "dustCoal", "dustCoal", "dustLead",
                                "dustLead", "dustSilver", "dustSilver", "dustIron", "dustIron" }));

        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.material, 4, 7),
                        new Object[] { new ItemStack(NCItems.parts, 1, 4), "dustCoal", "dustCoal", "ingotLead",
                                "ingotLead", "ingotSilver", "ingotSilver", "ingotIron", "ingotIron" }));

        GameRegistry.addRecipe(
                new ShapelessOreRecipe(new ItemStack(NCItems.fuel, 1, 45), new Object[] { "filledNCGasCell" }));
        ...
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.material, 2, 79),
                        new Object[] { "dustGraphite", "dustDiamond" }));

        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.material, 2, 80),
                        new Object[] { "ingotLithium", "ingotManganeseDioxide" }));
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.material, 2, 81),
                        new Object[] { "dustLithium", "dustManganeseDioxide" }));
        ...
        if (!workspace) {
            GameRegistry.addRecipe(
                    new ShapelessOreRecipe(
                            ...
                            new Object[] { "plateBasic", "plateLead", "plateLead", new ItemStack(NCItems.parts, 1, 10),
                                    new ItemStack(NCItems.parts, 1, 11), new ItemStack(NCItems.parts, 1, 12),
                                    new ItemStack(NCItems.parts, 1, 13), new ItemStack(NCItems.parts, 1, 16),
                                    "dustRedstone" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "blockGlass", 'B', "plateBasic", 'C', "ingotTough",
                                    'D', "plateLead" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.fissionReactorSteamIdle,
                            true,
                            new Object[] { "BAB", "ACA", "BAB", 'A', new ItemStack(NCItems.parts, 1, 7), 'B',
                                    "plateAdvanced", 'C', NCBlocks.fissionReactorGraphiteIdle }));
            GameRegistry.addRecipe(
                    new ShapelessOreRecipe(NCBlocks.blastBlock, new Object[] { NCBlocks.reactorBlock, "oreObsidian" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            new ItemStack(NCItems.parts, 1, 9),
                            true,
                            new Object[] { "AAA", "BCB", "AAA", 'A', new ItemStack(NCItems.material, 1, 48), 'B',
                                    "plateDU", 'C', "dustDiamond" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.separatorIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateLead", 'B', "ingotTough", 'C',
                                    "dustRedstone", 'D', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.recyclerIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateLead", 'B', "ingotTough", 'C',
                                    "ingotHardCarbon", 'D', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.hastenerIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateLead", 'B', "universalReactant", 'C',
                                    "ingotTough", 'D', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.reactionGeneratorIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateLead", 'B',
                                    new ItemStack(NCItems.parts, 1, 5), 'C', "plateBasic", 'D',
                                    NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.electrolyserIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateReinforced", 'B',
                                    new ItemStack(NCItems.parts, 1, 7), 'C', "universalReactant", 'D',
                                    NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.oxidiserIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateDU", 'B', "universalReactant", 'C',
                                    "plateLead", 'D', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.ioniserIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateDU", 'B', "dustRedstone", 'C', "plateLead",
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "ingotTough", 'B', "plateBasic", 'C', "plateIron",
                                    'D', Blocks.piston }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.assemblerIdle,
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "ingotTough", 'B', "plateIron", 'C', "plateBasic",
                                    'D', Blocks.piston }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "CDC", "ABA", 'A', "plateReinforced", 'B',
                                    new ItemStack(NCItems.parts, 1, 5), 'C', "plateTin", 'D', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "BCB", "ABA", 'A', NCBlocks.reactionGeneratorIdle, 'B',
                                    "plateAdvanced", 'C', NCBlocks.electromagnetIdle }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.fusionReactorSteam,
                            true,
                            new Object[] { "BAB", "ACA", "BAB", 'A', new ItemStack(NCItems.parts, 1, 7), 'B',
                                    "plateAdvanced", 'C', NCBlocks.fusionReactor }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.superElectromagnetIdle,
                            true,
                            new Object[] { "AAA", "BCB", "AAA", 'A', "plateAdvanced", 'B',
                                    new ItemStack(NCItems.parts, 1, 17), 'C', "ingotTough" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.synchrotronIdle,
                            true,
                            new Object[] { "AAA", "BCB", "AAA", 'A', NCBlocks.superElectromagnetIdle, 'B',
                                    "plateAdvanced", 'C', NCBlocks.machineBlock }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.supercoolerIdle,
                            true,
                            new Object[] { "AAA", "BCB", "AAA", 'A', "plateAdvanced", 'B',
                                    new ItemStack(NCItems.parts, 1, 13), 'C', "universalReactant" }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            new Object[] { "ASP", "HIW", " I ", 'I', "ingotIron", 'A', NCItems.toughAlloyAxe, 'S',
                                    NCItems.toughAlloyShovel, 'P', NCItems.toughAlloyPickaxe, 'H',
                                    NCItems.toughAlloyHoe, 'W', NCItems.toughAlloySword }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCItems.dUPickaxe,
                            true,
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCItems.dUPaxel,
                            true,
                            new Object[] { "ASP", "HIW", " I ", 'I', "ingotIron", 'A', NCItems.dUAxe, 'S',
                                    NCItems.dUShovel, 'P', NCItems.dUPickaxe, 'H', NCItems.dUHoe, 'W',
                                    NCItems.dUSword }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "PCP", "MMM", "PCP", 'P', "plateIron", 'C',
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCBlocks.denseSteamDecompressor,
                            true,
                            new Object[] { "PPP", "CCC", "PPP", 'P', "plateAdvanced", 'C',
                                    NCBlocks.steamDecompressor }));
            if (enableNukes) {
                GameRegistry.addRecipe(
                        new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "CDC", "AAA", 'A', Blocks.wool, 'B', Items.string, 'C', "plateLead",
                                    'D', Items.ender_eye }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            NCItems.pistol,
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "B B", "ABA", 'A', "plateTin", 'B',
                                    new ItemStack(NCItems.fuel, 1, 34) }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "ABA", "BCB", "ABA", 'B', new ItemStack(NCItems.parts, 1, 15), 'C',
                                    "ingotTough", 'A', new ItemStack(NCItems.parts, 1, 3) }));
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
            ...
            GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                            ...
                            true,
                            new Object[] { "AAA", "BCB", "DDD", 'A', "ingotLithiumManganeseDioxide", 'B',
        ...
        if (enableLoot) {
            ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dominoes, 1), 2, 4, 2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.ricecake, 1), 2, 4, 2 * lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
                    new WeightedRandomChestContent(
                            ...
                            2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dUBullet, 1), 6, 8, 4 * lootModifier));

            ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dominoes, 1), 1, 3, 2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.ricecake, 1), 1, 3, 2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.recordPractice, 1), 1, 1, lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.recordArea51, 1), 1, 1, lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(
            ...
            ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_DESERT_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.ricecake, 1), 1, 2, 2 * lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_DISPENSER).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dUBullet, 1), 6, 8, 5 * lootModifier));

            ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dominoes, 1), 1, 5, 2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.PYRAMID_JUNGLE_CHEST).addItem(
            ...
            ChestGenHooks.getInfo(ChestGenHooks.VILLAGE_BLACKSMITH).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.toughHelm, 1), 1, 1, 2 * lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.toughAlloyPaxel, 1), 1, 1, lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 9), 4, 6, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 16), 7, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 17), 7, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 0), 7, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 4), 7, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CORRIDOR).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 14), 6, 8, 4 * lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(
                            ...
                            2 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 16), 4, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 17), 4, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 0), 4, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 4), 4, 8, 4 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_CROSSING).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.parts, 1, 14), 6, 8, 4 * lootModifier));

            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_LIBRARY).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.dominoes, 1), 4, 5, 3 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_LIBRARY).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.ricecake, 1), 4, 5, 3 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_LIBRARY).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.fuel, 1, 46), 1, 1, 3 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.STRONGHOLD_LIBRARY).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.fuel, 1, 75), 4, 5, 7 * lootModifier));
            ...
            ChestGenHooks.getInfo(ChestGenHooks.BONUS_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.ricecake, 1), 2, 3, 3 * lootModifier));
            ChestGenHooks.getInfo(ChestGenHooks.BONUS_CHEST).addItem(
                    new WeightedRandomChestContent(new ItemStack(NCItems.boiledEgg, 1), 2, 3, 3 * lootModifier));
        }
        ...
        /*
         * NBTTagCompound oxygenFilling = new NBTTagCompound(); oxygenFilling.setTag("input", new
         * ItemStack(NCItems.fuel, 1, 45).writeToNBT(new NBTTagCompound())); oxygenFilling.setTag("gasType",
         * GasRegistry.getGas("oxygen").write(new NBTTagCompound())); oxygenFilling.setTag("output", new
         * ItemStack(NCItems.fuel, 1, 35).writeToNBT(new NBTTagCompound())); FMLInterModComms.sendMessage("Mekanism",
         * "ChemicalInjectionChamberRecipe", oxygenFilling); NBTTagCompound hydrogenFilling = new NBTTagCompound();
         ...
         * FMLInterModComms.sendMessage("Mekanism", "ChemicalInjectionChamberRecipe", hydrogenFilling); NBTTagCompound
         * deuteriumFilling = new NBTTagCompound(); deuteriumFilling.setTag("input", new ItemStack(NCItems.fuel, 1,
         * 45).writeToNBT(new NBTTagCompound())); deuteriumFilling.setTag("gasType",
         * GasRegistry.getGas("deuterium").write(new NBTTagCompound())); deuteriumFilling.setTag("output", new
         * ItemStack(NCItems.fuel, 1, 37).writeToNBT(new NBTTagCompound())); FMLInterModComms.sendMessage("Mekanism",
         * "ChemicalInjectionChamberRecipe", deuteriumFilling); NBTTagCompound tritiumFilling = new NBTTagCompound();
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileReactionGenerator.class.getCanonicalName());
        FMLInterModComms
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileFissionReactorSteam.class.getCanonicalName());
        FMLInterModComms
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileFusionReactorSteam.class.getCanonicalName());
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileSteamDecompressor.class.getCanonicalName());
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileFusionReactorBlock.class.getCanonicalName());
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileSuperElectromagnet.class.getCanonicalName());
        FMLInterModComms
        ...
        FMLInterModComms.sendMessage(
                "appliedenergistics2",
                "whitelist-spatial",
                TileLithiumIonBattery.class.getCanonicalName());
        FMLInterModComms
    ...
    public void l(int meta, String fertile, String fissile) {
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        ...
                        new Object[] { fertile, fertile, fertile, fertile, fertile, fertile, fertile, fertile,
                                fissile }));
    }
    ...
    public void h(int meta, String fertile, String fissile) {
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.fuel, 1, meta),
                        new Object[] { fertile, fertile, fertile, fertile, fertile, fissile, fissile, fissile,
                                fissile }));
    }
    ...
    public void c(int meta, String fuel) {
        GameRegistry.addRecipe(
                new ShapelessOreRecipe(
                        new ItemStack(NCItems.fuel, 1, meta),
                        new Object[] { fuel, new ItemStack(NCItems.fuel, 1, 33) }));
    }
