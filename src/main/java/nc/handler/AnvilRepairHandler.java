...
public final class AnvilRepairHandler {
    ...
    private boolean isValidRepairItem(final Item tool, final ItemStack stack) {
        ...
        if (stack != null && tool != null) {
            ...
            if (tool == NCItems.dUAxe || tool == NCItems.dUHoe
                    ...
                    || tool == NCItems.dUSword)
                return stack.getItem() == new ItemStack(NCItems.parts, 1, 8).getItem();
    ...
    public void onAnvilChange(final AnvilUpdateEvent event) {
        ...
        if (itemToRepair == null || repairMaterial == null
                || !isValidRepairItem(itemToRepair.getItem(), repairMaterial))
            return;
        ...
        if (canBeRepaired(itemToRepair)) {
            ...
            if (itemToRepair.getItem() == NCItems.bronzeAxe || itemToRepair.getItem() == NCItems.bronzeHoe
                    ...
                    || itemToRepair.getItem() == NCItems.bronzeSword)
                repairAmount = 300;
            if (itemToRepair.getItem() == NCItems.toughAlloyAxe || itemToRepair.getItem() == NCItems.toughAlloyHoe
                    ...
                    || itemToRepair.getItem() == NCItems.toughBow)
                repairAmount = 2500 / 2;
            if (itemToRepair.getItem() == NCItems.dUAxe || itemToRepair.getItem() == NCItems.dUHoe
                    ...
                    || itemToRepair.getItem() == NCItems.dUSword)
                repairAmount = 6400 / 2;
            if (itemToRepair.getItem() == NCItems.boronAxe || itemToRepair.getItem() == NCItems.boronHoe
                    ...
                    || itemToRepair.getItem() == NCItems.boronSword)
                repairAmount = 1200;
