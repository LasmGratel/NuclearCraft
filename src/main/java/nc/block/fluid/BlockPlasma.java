...
public class BlockPlasma extends BlockFluidClassic {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
         ...
         * world.setBlock(x, y, z, NCBlocks.plasmaFire); if (tickCount >= 20) { if (this.isSourceBlock(world, x, y, z)
         * && (world.getBlock(x, y + 1, z) == Blocks.air || world.getBlock(x, y + 1, z) == NCBlocks.plasmaFire ||
         * world.getBlock(x, y + 1, z) == NCBlocks.blockFusionPlasma)) { world.setBlock(x, y, z, Blocks.air);
         * world.setBlock(x, y + 1, z, NCBlocks.blockFusionPlasma); } } else tickCount ++;
         */
