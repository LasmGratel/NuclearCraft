...
public class BlockSimpleQuantum extends BlockContainer {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack itemstack) {
        ...
        /*
         * m(world, elb, Matrix.spinZ(1, 0.5, 1)); m(world, elb, Matrix.spinX(1, 0.5, 1)); m(world, elb, Matrix.spinY(1,
         * 0.5, 1)); m(world, elb, Matrix.spinZ(2, 0.5, 1)); m(world, elb, Matrix.spinX(2, 0.5, 1)); m(world, elb,
         * Matrix.spinY(2, 0.5, 1));
         */
    }
